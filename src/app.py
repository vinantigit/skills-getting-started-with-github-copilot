...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["kai@mergington.edu", "nina@mergington.edu"]
    },
    "Basketball Club": {
    ...
    "Math Olympiad": {
        "description": "Advanced problem solving and competitive math preparation",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 12,
        "participants": ["sara@mergington.edu", "alex@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on science experiments and discussion sessions",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["nora@mergington.edu", "brian@mergington.edu"]
    }
}
